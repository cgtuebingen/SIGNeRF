...
class Viewer:
    ...
    def __init__(
        ...
        self.waiting_train = self.viser_server.add_gui_button(
            label="Generate Dataset & Train", icon=viser.Icon.PLAYER_PLAY_FILLED, visible=False
        )
        ...
        self.tabs = self.viser_server.add_gui_tab_group()
        control_tab = self.tabs.add_tab("Control", viser.Icon.SETTINGS)
        with control_tab:
