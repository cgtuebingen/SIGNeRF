"""" Configuration file for the SIGNeRF method """
...
from signerf.signerf import SIGNeRFModelConfig
...
signerf_method = MethodSpecification(
    ...
    description="SIGNeRF method (high quality)",
)